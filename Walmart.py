...
features = pd.read_csv('C:/Users/admin/PycharmProjects/Walmart/features.csv')
train = pd.read_csv('C:/Users/admin/PycharmProjects/Walmart/train.csv')
stores = pd.read_csv('C:/Users/admin/PycharmProjects/Walmart/stores.csv')
test = pd.read_csv('C:/Users/admin/PycharmProjects/Walmart/test.csv')
sample_submission = pd.read_csv('C:/Users/admin/PycharmProjects/Walmart/sampleSubmission.csv')
